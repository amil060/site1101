  ...
  <div class="container">
    ...
    <div class="featured-grid">
      <article class="featured-card">
        <img class="thumb-small" src="{{ site.baseurl }}/assets/images/project1-hardware.jpg" alt="Hardware thumbnail" />
      ...
      <article class="featured-card">
        <img class="thumb-small" src="{{ site.baseurl }}/assets/images/project2-hour-of-code.jpg" alt="Hour of Code thumbnail" />
        <div class="featured-card__body">
